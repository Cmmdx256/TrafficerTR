...
export class IntentRouter {
  ...
  buildHandlers() {
    return {
      ...
      eat_food: () => ({ type: 'survival', engine: 'survival', action: 'eat' }),
      eat: () => ({ type: 'survival', engine: 'survival', action: 'eat' }),
      sleep: () => ({ type: 'survival', engine: 'survival', action: 'sleep' }),
      hide: () => ({ type: 'survival', engine: 'survival', action: 'hide' }),
      escape: () => ({ type: 'survival', engine: 'survival', action: 'escape' }),
      ...
      gather_stone: (intent) => ({
        ...
        engine: 'mining',
        skill: 'mine_ore',
        args: { ore: 'stone', ...intent.parameters }
      }),
      gather_coal: (intent) => ({
        type: 'mining',
        engine: 'mining',
        skill: 'mine_ore',
        args: { ore: 'coal', ...intent.parameters }
      }),
      gather_iron: (intent) => ({
        type: 'mining',
        engine: 'mining',
        skill: 'mine_ore',
        args: { ore: 'iron', ...intent.parameters }
      }),
      gather_copper: (intent) => ({
        type: 'mining',
        engine: 'mining',
        skill: 'mine_ore',
        args: { ore: 'copper', ...intent.parameters }
      }),
      gather_diamond: (intent) => ({
        type: 'mining',
        engine: 'mining',
        skill: 'mine_ore',
        args: { ore: 'diamond', ...intent.parameters }
      }),
      mine_ore: (intent) => ({
        type: 'mining',
        engine: 'mining',
      ...
      craft_pickaxe: (intent) => ({
        type: 'crafting',
        engine: 'crafting',
        skill: 'craft_item',
        args: { item: 'pickaxe', ...intent.parameters }
      }),
      craft_table: (intent) => ({
        type: 'crafting',
        engine: 'crafting',
        skill: 'craft_item',
        args: { item: 'crafting_table', ...intent.parameters }
      }),
      craft_furnace: (intent) => ({
        type: 'crafting',
        engine: 'crafting',
        skill: 'craft_item',
        args: { item: 'furnace', ...intent.parameters }
      }),
      craft_chest: (intent) => ({
        type: 'crafting',
        engine: 'crafting',
        skill: 'craft_item',
        args: { item: 'chest', ...intent.parameters }
      }),
      smelt_item: (intent) => ({
        type: 'crafting',
        engine: 'crafting',
      ...
      smelt_iron: (intent) => ({
        ...
        engine: 'crafting',
        skill: 'smelt_item',
        args: { item: 'iron', ...intent.parameters }
      }),
      ...
      hunt_animal: (intent) => ({
        ...
        engine: 'combat',
        skill: 'hunt_mob',
        args: { target: 'animal', ...intent.parameters }
      }),
      attack_target: (intent) => ({
        type: 'combat',
        engine: 'combat',
        skill: 'attack_target',
        args: intent.parameters
      }),
      protect_player: (intent) => ({
        type: 'combat',
        engine: 'combat',
      ...
      build_house: (intent) => ({
        ...
        engine: 'building',
        skill: 'build_structure',
        args: { type: 'house', ...intent.parameters }
      }),
      build_farm: (intent) => ({
        type: 'building',
        engine: 'building',
        skill: 'build_structure',
        args: { type: 'farm', ...intent.parameters }
      }),
      build_bridge: (intent) => ({
        type: 'building',
        engine: 'building',
        skill: 'build_structure',
        args: { type: 'bridge', ...intent.parameters }
      }),
      place_block: (intent) => ({
        type: 'building',
        engine: 'building',
      ...
      search_resource: (intent) => ({
        type: 'exploration',
        engine: 'exploration',
        skill: 'search_resource',
        args: intent.parameters
      }),
      find_structure: (intent) => ({
        type: 'exploration',
        engine: 'exploration',
        skill: 'find_structure',
        args: intent.parameters
      }),

      // Mobility & Movement
      follow_player: (intent) => ({
        type: 'mobility',
        engine: 'mobility',
        skill: 'follow_player',
        args: intent.parameters
      ...
      // Utility
      idle: () => ({ type: 'utility', engine: 'none', action: 'idle' }),
      wait: () => ({ type: 'utility', engine: 'none', action: 'wait' })
    }
  }
