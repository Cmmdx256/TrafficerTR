...
const suspendedMinecraftVersions = new Set(['26.1', '26.1.1', '26.1.2'])

export function resolveMinecraftVersion(version) {
  return versionAliases[version] || version || false
}

export function isSuspendedMinecraftVersion(version) {
  return suspendedMinecraftVersions.has(String(version))
}
